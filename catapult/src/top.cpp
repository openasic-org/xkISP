...
//    #pragma HLS INTERFACE s_axilite port=scaledown_register bundle=scaledown_regs
    ...
    static stream_u42 gtm_lut_data;
    static stream_u42 lut_ltm_data;
    ...
    gtm(top_register, gtm_register, cmc_gtm_data, gtm_lut_data);
    lut(top_register, lut_register, gtm_lut_data, lut_ltm_data);
