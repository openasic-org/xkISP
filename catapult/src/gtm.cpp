        ...
        gtm_col: for (uint13 x=0; x<top_reg.frameWidth; x++){
            ...
            if(gtm_reg.eb == 1) {
                //gtm_cal: for (int k=0; k<3; k++) {
                    index = src_w[0] >> 7;
                    x_value = src_w[0] & 0x7f;
                    if (gtm_reg.gtmTab_0[index] !=0) {
                        y_pos0 = gtm_reg.gtmTab_0[index] * 16 + 15;
                    } else {
                        y_pos0 = 0;
                    }
                    if (gtm_reg.gtmTab_0[index+1] !=0) {
                        y_pos1 = gtm_reg.gtmTab_0[index+1] * 16 + 15;
                    } else {
                        y_pos1 = 1;
                    }
                    ...
                    if (gtm_reg.m_bDitheringEnable) {
                        temp2 = y_pos0*4 + temp1 + seed[y0*3+0];
                        seed[y0*3+0] = temp2 & 0x1f;
                        temp3 = temp2 >> 2;
                    } else {
                        temp3 = y_pos0 + ((temp1+2) >> 2);
                    }
                    dst_w[0] = gtm_clip(temp3,0,16383);
//
                    index = src_w[1] >> 7;
                    x_value = src_w[1] & 0x7f;
                    if (gtm_reg.gtmTab_1[index] !=0) {
                        y_pos0 = gtm_reg.gtmTab_1[index] * 16 + 15;
                    } else {
                        y_pos0 = 0;
                    }
                    if (gtm_reg.gtmTab_1[index+1] !=0) {
                        y_pos1 = gtm_reg.gtmTab_1[index+1] * 16 + 15;
                    } else {
                        y_pos1 = 1;
                    }
                    y_value = y_pos1-y_pos0;
                    ...
                    if (gtm_reg.m_bDitheringEnable) {
                        temp2 = y_pos0*4 + temp1 + seed[y0*3+1];
                        seed[y0*3+1] = temp2 & 0x1f;
                        temp3 = temp2 >> 2;
                    } else {
                        temp3 = y_pos0 + ((temp1+2) >> 2);
                    }
                    dst_w[1] = gtm_clip(temp3,0,16383);

                    index = src_w[2] >> 7;
                    x_value = src_w[2] & 0x7f;
                    if (gtm_reg.gtmTab_2[index] !=0) {
                        y_pos0 = gtm_reg.gtmTab_2[index] * 16 + 15;
                    } else {
                        y_pos0 = 0;
                    }
                    if (gtm_reg.gtmTab_2[index+1] !=0) {
                        y_pos1 = gtm_reg.gtmTab_2[index+1] * 16 + 15;
                    } else {
                        y_pos1 = 1;
                    }
                    y_value = y_pos1-y_pos0;
                    ...
                    if (gtm_reg.m_bDitheringEnable) {
                        temp2 = y_pos0*4 + temp1 + seed[y0*3+2];
                        seed[y0*3+2] = temp2 & 0x1f;
                        temp3 = temp2 >> 2;
                    } else {
                        temp3 = y_pos0 + ((temp1+2) >> 2);
                    }
