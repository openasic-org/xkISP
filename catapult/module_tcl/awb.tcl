...
go assembly
directive set /awb/core/awb_row -PIPELINE_INIT_INTERVAL 1
...
directive set /awb/awb_reg.r_gain:rsc -MAP_TO_MODULE ccs_ioport.ccs_out
directive set /awb/awb_reg.g_gain:rsc -MAP_TO_MODULE ccs_ioport.ccs_out
directive set /awb/awb_reg.b_gain:rsc -MAP_TO_MODULE ccs_ioport.ccs_out
directive set /awb/core/ac_math::ac_div<12,12,12,12>:for -PIPELINE_INIT_INTERVAL 1
directive set /awb/core/ac_math::ac_div<12,12,12,12>#1:for -PIPELINE_INIT_INTERVAL 1
go architect
go extract
