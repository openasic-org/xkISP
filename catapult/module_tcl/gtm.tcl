...
directive set /gtm/gtm_reg.gtmTab:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /gtm/gtm_reg.gtmTab:rsc -PACKING_MODE sidebyside
directive set /gtm/gtm_reg.gtmTab -WORD_WIDTH 1290
directive set /gtm/core/gtm_reg.gtmTab:rsc -MAP_TO_MODULE {[Register]}
