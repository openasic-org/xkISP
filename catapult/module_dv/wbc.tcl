...
solution file add ../tb/tb_wbc_catapult.cpp -type C++ -exclude true
...
directive set /wbc/top_reg.ROW_TEST:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /wbc/top_reg.COL_TEST:rsc -MAP_TO_MODULE {[DirectInput]}
