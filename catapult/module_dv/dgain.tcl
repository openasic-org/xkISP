...
solution file add ../tb/tb_dgain_catapult.cpp -type C++ -exclude true
...
directive set /dgain/top_reg.ROW_TEST:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /dgain/top_reg.COL_TEST:rsc -MAP_TO_MODULE {[DirectInput]}
