        ...
        afc_col: for (uint13 col = 0; col < top_reg.frameWidth; col++){
            ...
            if(afc_reg.eb == 1){
                ...
                if(((row >= afc_up + 8) && (col >= afc_left + 8)) && ((row <= afc_down) && (col <= afc_right))){
                    ...
                    sobel_cal = abs(sobel_h_cal, 0) + abs(sobel_v_cal, 0);
