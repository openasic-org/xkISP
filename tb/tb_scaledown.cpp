...
int main(int argc, char** argv)
{
    ...
    uint16_t* frameGolden_1 = (uint16_t*)malloc(3 * out_width_1 * out_height_1 * sizeof(uint16_t));
    uint16_t* frameOut_1 = (uint16_t*)malloc(3 * out_width_1 * out_height_1 * sizeof(uint16_t));
